...
import { IntervalToIndexMap, TickDataArray, CurrencyOHLCVTNames } from '../../types';
...
export default async function writeUpdateToSql(tickerArray: TickDataArray[], pair: string, interval:string) {
